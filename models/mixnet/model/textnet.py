...
class TextNet(nn.Module):
    def __init__(self, backbone='FSNet_M', embed=True, mid=True, pos=True, num_points=20,dist_threshold=.3, cls_threshold=.85):
        super().__init__()
    ...
    def forward(self, x):
        ...
        init_polys, confs, index = self._generate_boundary(dis_preds, cls_preds,self.dist_threshold, self.cls_threshold )
